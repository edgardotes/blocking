...
####====INPUT
xr_in=xr.open_mfdataset('/scratch/b/b382006/nextgems/prefinal/IFS_9-FESOM_5-production-hist/vapv/IFS_9-FESOM_5-production-hist_vapv-19*',concat_dim='time',combine='nested')

###===OUTPUT
outpath = '/scratch/b/b382006/nextgems/prefinal/IFS_9-FESOM_5-production-hist/block/ANO_VAPV'

###==subfix era5
subfix='-ifs-ano_1990-1999'
