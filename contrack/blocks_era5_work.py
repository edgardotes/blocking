...
def calc_gh_anom():
    ...
    ### open era5 files
#    xr_in=xr.open_mfdataset('/work/bm1235/b382006/era5/z500/era5_regio_prl*')
    xr_in=xr.open_mfdataset('/scratch/b/b382006/obs/era5/factory/z500/era5_regio_prl*')
    ...
    ### save full dataset
#    anom_gh.to_netcdf('/scratch/b/b382006/obs/era5/factory/era5-anom-z500.nc')
 ...
 #       anoms = xr.concat([anom_pre,anoms], dim = "time")
    ...
    #print(anoms)
        outfile="era5-anom-z500_"+str(yy)+".nc"
        print(outfile)

        anoms.to_netcdf('/scratch/b/b382006/obs/era5/factory/'+outfile+'')
