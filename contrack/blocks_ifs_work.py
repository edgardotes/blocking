####=================================================
# Adapted by Edgar Dolores to  work with IFS dataset structure 
# ************nextGEMS project*****************************
...
#            pv_int = interpolate(pv, p, plevel) # ICON from top-to-bottom
...
#                iny=30
#                inx=40
#                porg=np.squeeze(p[:,iny,inx])
#                pvorg=np.squeeze(pv[:,iny,inx])
#
#                ppv=np.squeeze(pv_int[:,iny,inx])
#                press=np.squeeze(plevel[:])
#
#                print(porg)
#                print(pvorg)
#                print(ppv)
...
#                fig, ax = plt.subplots(figsize=(7.2,13))
#                plt.gca().invert_yaxis()
#                plt.plot(ppv[:],press[:],'o-', color='k', lw='3', label = 'PV model levels')
#                ax.axhline(hgh_up,color='blue', lw=1)
#                ax.axhline(hgh_up2,color='blue', lw=1)
#
#                ax.axvline(7.94,color='black', lw=1)
#                ax.axvline(7.41,color='red', lw=1)
#                plt.show()
#                print(hahaxh)

                vapv = np.mean(pv_int,axis=0)
...
#    outfile = outpath + '/vapv_weighted/' + 'VAPV_' + outname 
    ...
    time.units = 'minutes since 2020-01-20 00:00:00'
...
def calc_gh_anom():
    ...
    version='IFS_9-NEMO_25'

    ### open ifs files
    inpath='/scratch/b/b382006/nextgems/cycle3/'+version+'-cycle3/z500/6H/'
    print(inpath)
    ###IFS 4.4km
    xr_in=xr.open_mfdataset(inpath+'z500_ifs_c3_*')
    prefix="ifs-c3"
    outdir="/scratch/b/b382006/nextgems/cycle3/"+version+"-cycle3/z500/"

#    ## IFS_28-NEMO_25
#    xr_in=xr.open_dataset('/scratch/b/b382006/nextgems/cycle3/IFS_28-NEMO_25/z500/z500_ifs_c3_2020-2024_6h.nc')
#    prefix="ifs-c3"
#    outdir="/scratch/b/b382006/nextgems/cycle3/IFS_28-NEMO_25/z500/"

#    ## IFS_28-NEMO_25
#    xr_in=xr.open_mfdataset('/scratch/b/b382006/nextgems/cycle3/IFS_28-FESOM_25-cycle3/z500/6H/z500_ifs_c3_*')
#    prefix="ifs-c3"
#    outdir="/scratch/b/b382006/nextgems/cycle3/IFS_28-FESOM_25-cycle3/z500/"
