...
####====INPUT
for yy in range(1990,2023):
    print("1. Load files")
    xr_in=xr.open_dataset("/scratch/b/b382006/obs/era5/factory/era5-anom-z500_"+str(yy)+".nc")
