####=================================================
# Adapted by Edgar Dolores to  work with ICON dataset structure 
# ************nextGEMS project*****************************
...
def calc_gh_anom():
    ...
    #ncg3028 (c3)
    xr_in=xr.open_mfdataset('/scratch/b/b382006/nextgems/cycle3/ngc3028/z500/6h/z500_icon_c3_1D_*')
    var="zg"
    prefix="ngc3028"
