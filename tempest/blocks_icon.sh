...
loadpath=/scratch/b/b382006/nextgems/cycle$cycle/$version/z500/6h/z500_${model}_c${cycle}*
...
###cdo -b F32 daymean -mergetime $loadpath $savepath/${version}_z500_day.nc
